...
armory_guard_dlg = dlg {
	...
	phr = {
		...
		};
		{
			...
			[[
				-- Ну да, железяка-то, значится, неплохая! -- солдат неожиданно взмахивает мечом,
				...
				умельцев больше, кто бы с ним мог управиться.
				Так, палач изредка на эшафоте машет. А я его от пыли оттираю.
				^
