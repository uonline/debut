...
barracks_hq_docs = obj {
	...
	inv = [[
		...
		осаду. Затем здешний лорд должен будет разбить орков и занять город, подорвав
		влияние Режима. Схожие планы вынашиваются относительно других городов.
		^
		...
		и, возможно, город в небесах откроет тебе свои тайны.
		Используй содержимое шкатулки. Есть вещи, которые делают людей более
		сговорчивыми, даже если они из знатного рода."
		^
		-- Это всё что мне нужно? -- шепчешь ты крысе.
		^
		-- Уверен, подполье заинтересуют любые сведения об угрозах городу. Поверь,
		у них нет желания, менять Режим на орков или здешнего лорда. И участвовать
		в чьих-либо играх, они тоже не намерены.
	]];
	tak = function()
		take 'guard_docs';
