...
tower_picture = obj {
	...
	dsc = [[
		...
		^ Доспехи с оружием. Множество подсвечников.
		...
		^
		По полу разбросано множество всяких бумак. Стопки книг, свитки, несколько столиков и стульев.
		Пол занимает огромная карта Приграничья.
	]];
	act = [[
		Горизонт завален
	]];
...
-- TODO
-- Другие объекты тоже можно толкнуть копьём?
