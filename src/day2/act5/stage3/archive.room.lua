...
tower_stage3_archive_book_2 = obj {
	...
	act = function()
		return [[
			...
			^
			^
			Дочитав, ты кладёшь бумагу на место и кладёшь книгу обратно на стол.
		]];
	end;
}
...
tower_stage3_archive_book_3 = obj {
	...
	act = [[
		...
		под собой разветвлённую сеть катакомб. И иногда в этих катакомбах можно встеретить
		ходы ведущие в неизведанные глубины. Кто знает, что обитает в них. Сомнища
		кровожадных гоблинов или леденящие кровь призраки?
		Города Приграничья на руинах и городищах прошлого.
		Нежить, нечисть (страхолюды) и гоблины в глубинах.
		^
		^
