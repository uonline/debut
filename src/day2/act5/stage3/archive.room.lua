	...
	act = function()
		...
		if tower_stage3_archive_book_4_goblins then
			return [[
				...
				Эта запретная ветвь магии с древних времен манит к себе последователей,
				которых привлекает тайное знание. Тех же, что ищут могущества...
				^
				...
				Безумия. Пока мы не уделяем этой угрозе достаточное внимание, более того,
				многие считают культ выдумкой. Хотя можно узна
				^
				^
			]] .. stop_reading;
		end;
