...
tower_stage3_archive_book_2 = obj {
	...
	act = function()
		return [[
			...
			^
			^
			Дочитав, ты кладёшь бумагу на место и ставишь книгу обратно на полку.
		]];
	end;
}
...
tower_stage3_archive_book_3 = obj {
	...
	act = [[
		...
		^
		Книга-сборник странностей Приграничья, послeднее издание.
		...
		Нежить, нечисть (страхолюды) и гоблины в глубинах (тексты снабжены красочными иллюстрациями.
		Похоже воображение автора и художника разошлись).
		^
