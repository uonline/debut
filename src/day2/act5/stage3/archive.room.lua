...
tower_stage3_archive_book_3 = obj {
	...
	act = [[
		...
		записями дневника и посланием или письмом. Ты не упускаешь случая ознакомиться
		с их содержимым:
		^
		^
		Я очень хорошо помню первые месяцы Режима в городе. Хорошо я помню и первого
		наместника Режима. Он показался мне весьма рассудительным человеком по началу.
		Совет принял его благосклонно, и он ответил тем же. Намечалось что-то похожее
		на, хмм, сотрудничество? Эти иллюзии скоро развеялись. Вокруг наместника стали
		крутиться подозрительные личности. В совете начались жаркие споры.
		В книге ты находишь письмо бывшего советника о строительстве башни и подозрении
