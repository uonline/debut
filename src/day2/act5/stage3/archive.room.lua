...
tower_stage3_archive_book_2 = obj {
	...
	act = function()
		return [[
			...
			вкладыша плотной бумаги. Здесь ты останавливаешься, и начинаешь читать
			куски уцелевшего текста.
			^
			^
			...
			^
			Плодороные земли на берегах Карны приносили обильный
			урожай. Его хватало, чтобы кормить другу часть страны, лежащей средки скал и
			безлистных лесов. Здесь каменистые почвы были сухи и безжизнены, но зато таили
			в себе богатства иного рода. Шахтёры...
			Каменоломни. Крепости.
			...
			Когда же владения Эрадора достигли западного побережья, король повелел перенести
			столицу туда. Перенести столицу на запад к морю, где климат и условия были лучше.
			Скоро Эрадор затмил Тантикул...
			^
