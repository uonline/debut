...
tower_stage3_archive_guard = obj {
	nam = '';
	dsc = [[
		Неподалёку от стола на возвышении {Большая книга} на алтаре.
	]];
	act = function()
...
tower_stage3_archive_guard_dlg = dlg {
	...
	entered = function()
		...
		book_guard_definition = [[
			Напоминает алтарь на котором лежит внушительная книга.
			Ты листаешь книгу и неожиданно обнаруживаешь на ней проступающие на чистой бумаге надписи
