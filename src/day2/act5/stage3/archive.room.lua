...
tower_stage3_archive_book_1 = obj {
	...
	act = [[
		...
		^
		Ты первый раз в жизни видишь, то о чём слышал не раз.
		^
		Серый цвет -- земли куда не ступала нога человека.
		Бурый цвет -- потерянные земли.
		На севере границы материка размыты, не видно ни бухт, ни топонимов.
		Про экспедиции Хргфхейма и Кдиного Ордена на Катор и Дарсу.
		Про Новый Лаш.
	]];
}
...
tower_stage3_archive_book_4 = obj {
	...
	act = [[
		...
		2. ПРо гоблинов, карлов и подземелья.
	]];
}
