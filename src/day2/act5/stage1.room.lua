...
tower_halfblood = obj {
	...
	act = function()
		...
		return [[
			...
			-- да он не знал, где тут лестница на следующий этаж. Все стараются держаться
			подальше отсюда. Единственный, кому есть
			дело до башни, так это нашему дорогому богоизбранному.
