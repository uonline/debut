...
tower_stage1_thieves_leader = obj {
	...
	act = [[
		...
		это не первая моя вылазка в башню. Учитывая, что все боятся её как огня,
		я подумывал устроить здесь схрон. Но всякий раз это место
		ставит меня в тупик. Сегодня, я снова в ступоре.
		^
		-- В ступоре? Что ты имеешь ввиду? -- удивляешься ты.
		^
		-- Сложно объяснить. не хочу показаться тебе сумасшедшим.
		Уверен, чуть позже ты сам всё поймёшь.
		^
		Бывший торгаш действительно выглядит несколько расстерянным.
		^
		-- Разве нам не надо пошевеливаться? Стража не нагрянет? -- беспокоишься ты.
		^
		-- Не думаю, -- главарь покачал головой, -- башня сама себя неплохо охраняет.
		Первый наместник, например, исчёз сразу же после завершения её строительства.
		Нынешний наместник здесь никогда и не жил. Его резидёнция -- один
		из лучших постоялых дворов в городе. Кроме советника Конроя других важных шишек
		в башне больше нет. А этого старика не особно торопятся охранять.
		^
		-- Хочешь сказать, что можно ничего не бояться?
	]];
}
