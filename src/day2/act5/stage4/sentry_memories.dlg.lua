	...
	phr = {
		...
		-- Диалог с птицей заканчивается, если не все секреты раскрыты;
		{
			...
			[[
				...
				Она лишь водит клювом из стороны в сторону.
			]];
			function()
		...
		-- Если игрок не взаимодействовал с Полукровкой в лагере гильдии: диалог главаря подполья и Полукровки
		{
			...
			[[
				...
				^
				-- Я слышала, изготовленное в Приграничье оружие, отправляется на север в Диовен, --
				замечает птица голосом девушки, -- не думала, что режимники всерьёз боятся остроухих.
				^
				-- 
				-- Нет, тут другое. Режимники люди дела, они не бросают слов на ветер.
				Тем более, если речь идёт о международном соглашении. Любые договоры там,
				строго соблюдаются.
				^
				-- Что я слышу, неужели Режим не так уж и плох?
				^
				Дело не в том плох он или хорош. У себя в стране режимники могут делать, что захотят.
				Но в Приграничье, они извращают нашу культуру и насаждают свою религию.
				То что создавалось веками, слепо уничтожается.
				Чтобы они не говорили, но здесь они занимаются разрушением, а никаким не созиданием.
				^
				* Созидать можно по разному, но вот разрушение и его результаты, всегда похожи.
				...
				Без забвения невозможно новое:
					* Возможно слишком долго Тантикул считался родиной и незыблимым ориентиром человечества.
					Слишком много в нём стало... эльфиского?
