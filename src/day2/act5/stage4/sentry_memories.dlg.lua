...
sentry_black_bird_dlg = dlg {
	...
	phr = {
		...
		-- Диалог с птицей заканчивается, если не все секреты раскрыты;
		{
			...
			[[
				Вместо ответа птица лишь водит клювом из стороны в сторону.
			]];
			function()
		...
		-- Если игрок прослушал все диалоги с крысой: диалог мага-крысы и первого городского наместника
		{
			...
			[[
				...
				эту войну.
				^
				-- А что насчёт вашей войны? -- вкрадчиво спрашивает птица голосом наместника,
				...
				^
				-- Вам не откажешь в прозорливости, наместник, -- не менее вкрадчиво отвечает
				...
				членами общества как и остальные блага. Ох, не нужно смотреть на меня такими
				удивлёнными глазами. Свобода это ресурс, запас которого может легко иссякнуть при
				распределении. Свобода это деньги, на которое люди покупают мнимое благополучие
				и признание в обществе. Вы продаёте свою свободу, когда идёте служить...
				Продажа своего времени в рабство.
				Всем нужны чьм-то чудие руки или мозги. Магос;
				^
				-- Вы весьма, весьма интересный собеседник, -- с удовольствием в голосе отзывается
				птица-наместник.
			]];
			function()
