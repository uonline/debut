	...
	phr = {
		...
		-- Если игрок прослушал все диалоги с крысой: диалог мага-крысы и первого городского наместника
		{
			...
			[[
				...
				сразу узнаёшь своего утреннего знакомца -- мага-крысу.
				^
				-- Что-нибудь о твоей радине, например. Столько слухов ходит о загадочном Магосе,
				-- ...
				^
				-- Магос не моя родина, -- поправляет голос мага, -- я родился в Вольных городах.
				^
				-- И всё же, -- не отстаёт голос наместника, -- ...
				^
				-- Что там ваши чудовща?
				^
				-- А разве в Режиме чудовищ не меньше? -- ...
				^
				* Все эти страхллюдины, ящеры, драконы пришли сюда из другого мира.
				...
				^
				-- Закончились мои свободы, -- усмехнулся голос мага.
				^
				-- Что вы имеете ввиду? -- ...
				^
