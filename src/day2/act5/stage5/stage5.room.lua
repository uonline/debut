...
tower_stage5_room3 = room {
	...
	enter = function()
		return [[
			...
			За дверью оказывается ещё один коридор более просторный.
			В этом коридоре окно или любые другие источники света отсутствуют,
			поэтому всё что тебе удаётся, это разглядеть ещё несколько дверей.
