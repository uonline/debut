	...
	phr = {
		...
		};
		{
			...
			_wrangler_take .. [[
				...
				^
				К твоему удивлению бард покорно слезает с постамента. Бритоголовый к в робе-мешке
				...
				жизнь на плахе.
				^
				-- Почему это он должен применяться за нас именно сейчас? -- к тебе приходит понимание,
