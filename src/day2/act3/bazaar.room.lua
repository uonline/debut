...
bazaar_aragorn = obj {
	nam = 'Эльф';
	dsc = [[
		{Эльф} сдаёт кольчуги в прокат. Рядом с ним стоит огромный громила
		орк видимо в качестве охранника.
	]];
	act = [[
		Ты подходишь к эльфу и внимательно осматриваешь его товар. Почему-то
		от каждой кольчуги несёт тухлой рыбой.
		^
		-- Что-то не так? У меня всё по закону, -- вальяжно отвечает торговец.
		^
		Test
		^
		-- А обезьяна дрессированная? -- спрашиваешь, кивая головой в сторону
		громилы. Орк в ответ свирепо скалит огромные клыки. Ты и сам
		удивляешься собственной дерзости.
