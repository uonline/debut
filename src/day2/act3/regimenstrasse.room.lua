...
regimenstrasse_girl = obj {
	...
	act = function()
		...
		[[
			...
			как откуда-то послышались взволнованные крики. Ты только обернулся и вот перед
			тобой уже стоит запыхавшаяся женщина. Из-под её платка выпадают пряди растрёпанных
			волос. С радостным криком девочка бросается к матери, и оказывается у той на руках.
			^
			-- Ох, я не спала всю ночь, вот и зазевалась, не заметила, как Дайан отстала.
			В этом возврасте её привлекает любой шум, -- стыдливо объясняется женщина,
			...
			-- Что вы имеете ввиду?
			^
			-- Мы с Дайан проходили рядом с городскими воротами, когда туда вошёл патруль.
			Краем уха мне удалось услышать, что несколько дней назад они наткнулись в лесу
			на разорённый караван. Просто ужас, лошади, люди, все перебиты, повозки,
			разграблены, и никто не понимает, зачем их понесло так далеко в чащу.
			^
