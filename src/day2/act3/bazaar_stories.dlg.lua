	...
	phr = {
		...
		-- Просишь рассказать про Имперские колонии
		{
			...
			[[
				...
				проклятыми эльфийскими лесами или пустыней мерзких жуков. Хотя в том же Режиме
				проблем не меньше: все эти еретические секты, жуткие истории про призраков
				Скалистого полуострова и гоблинские полчища в тундрах, -- торговец
				втянул голову в плечи, словно от озноба.
				^
				Ты скептически поднял бровь,
		...
		-- Просишь рассказать про Термитники
		{
			false;
			tag='termites';
			'Ты кажется упоминал каких-то пустнных жуков.';
			[[
				-- Верно. Вы южане наверное и не слышали про нашу главную беду
				-- Термитники.
				^
				Ты неуверенно покачал головой.
				^
				-- О, полисы на западе страны только и заняты, патрулированием
				границы с пустыней. Её пески просто кишат этими тварями...
				Ходят слухи, что полисам приходится обращаться за
				помощью к богомерзким чернокнижникам с Мистического архипелага. Иначе
				эту напасть просто не удержать. Но что ещё хуже, никто пока не понимает,
				почему жуки не расширяют свои владения, и чем они там питаются.
				Говорят в средце пустыни -- Пепельных горах -- обитают чудища пострашнее.
			]];
		};
