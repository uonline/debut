...
bazaar_stories = dlg {
	...
	phr = {
		...
		-- Просишь рассказать про Имперские колонии
		{
			...
			[[
				Я бы сказал, как и везде. Если ты священнослужитель с большой
				паствой в крупном Полисе, и можешь позволить себе особняк у лазурных волн
				восточного побережья, то у тебя просто райская жизнь.
				...
				все гнёзда ящеров в местных лесах.
				Что уж и говорить о торговцах, что странствуют по миру, наблюдая
				все его напасти.
			]];
			function()
