	...
	phr = {
		...
		-- Просишь рассказать про Термитники
		{
			...
			[[
				...
				наверняка, Термитники никода не пытались расширять владения за пределы пустыни.
				Такое ощущение, что что-то удерживает их там.
				^
				-- Возможно, они питаются там чем-то, -- решаешься на догадку ты.
				^
				-- Да, некоторые тоже так считают, -- соглашается торговец, -- говорят в средце
				...
				^
				-- Никто не знает. Мутанотов можно встретить начиная с северных областей Режима
