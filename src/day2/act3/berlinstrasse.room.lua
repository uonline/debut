...
berlinstrasse_boy = obj {
	...
	act = function()
		...
		return [[
			...
			В ночь перед битвой он предложил спор, кто больше выпьет,
			и мечник, уверенный в своей победе, согласился. Но коварный командир
			разбавил своё пиво водой. Когда его соперник, захмелев, уснул, командир подменил
			...
			закончилась и она не смогла отказать командиру, став его женой.
