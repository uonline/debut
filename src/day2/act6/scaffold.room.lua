...
scaffold_action = function(act_text)
	...
	local orc_band_attack_text = hero_execution_start_text .. [[
		...
		улиц и переулков. Вокруг эшафота разверзается хаос. Люди бросаются кто куда,
		...
		^
		Ты видишь как сразу дюжина орочьих рук впивается в эшафот с разных сторон.
		Не дожидаясь пока.. Богоизбранный Один за другим на доски забираются вояки урук-хай.
		^
		Ты видишь как по лестнице на эшафот поднимается урук из Харгфхейма.
		^
		Скидывает тебя с эшафота.
	]];
	...
	act = function()
		local text = {
			...
			[3] = [[
				...
				Не выдержав, ты отводишь взгляд, а в голову к тебе закрадываются странные мысли:
