...
scaffold_action = function(act_text)
	local signer_execution_text = [[
		...
		^
		Тебе же остаётся лишь догадываться, видел ли менестрель перед смертью
		огонь лиловых глаз.
	]];
	...
	local propagandist_execution_text = [[
		...
		^
		-- ... -- прочистив горло, начинает глашатай, -- ...
		^
		-- Прекрасно, -- палач-богоизбранный ставит приговорённого на колени.
