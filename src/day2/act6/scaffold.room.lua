...
scaffold_propagandist_and_singer = obj {
	...
	act = function()
		...
		return [[
			...
			^
			-- Гляди ка какая метаморфоза, -- менестрель указывает на тебя толстым пальцем,
			-- на рассвете солдат Режима, на закате приговорённый к плахе.
			^
			-- Вы тоже продолжаете выступать, как я посмотрю, -- отзываешься ты, кивая
			на эшафот, -- скоро на сцену, толпа ждёт?
			^
			-- Люди ждут убийцу советника...
			^
