	...
	dsc = function()
		local text = {
			...
			[2] = [[
				...
				Это {проповедник}, которого ты видел в лагере подполья на куче книг.
			]];
			[3] = [[
				Позади тебя странно улыбается худощавая {личность}. Ты вспоминаешь, что
				видел её в лагере подполья, молящейся на куче книг.
			]];
		};
...
scaffold_godchosen = obj {
	...
	act = function()
		return scaffold_action [[
			...
			Странно наблюдать богоизбранного в качестве палача, да и ему самому эта
			роль не в радость.
