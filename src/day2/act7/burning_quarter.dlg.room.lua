	...
	phr = {
		...
		-- О желании проповедника
		{
			...
			[[
				...
				Лишь белая маска лица и длинные кисти рук отражали всполохи пожара.
				^
				...
				Кинжал мерцает сёрым, словно игнорируя вспышки красного и оранжевого вокруг.
				^
				-- Я хочу чтобы ты исчез, -- раздаётся шёпот у тебя в голове.
			]];
			function()
