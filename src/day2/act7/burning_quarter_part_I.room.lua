...
burning_quarter_rolled_barrels = obj {
	...
	act = function()
		...
		return burning_quarter_action([[
			...
			Они с грохотом скатываются вниз по склону.
...
burning_quarter_hammer = obj {
	nam = 'Молот урук-хай';
	inv = [[
		Уродливый молот урук-хай. Наверняка какой-то урук орудовал
		им одной рукой. Но ты с трудом удерживаешь его двумя руками.
	]];
}
