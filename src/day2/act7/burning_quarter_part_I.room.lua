...
burning_quarter_place = obj {
	...
	act = function()
		return [[
			Ты осматриваешь горящий квартал...
			^
			Залитый солнечным светом город, теперь был залит светом зарева пожара.
			...
			страдание в бурлении хаоса случайности.
		]];
	end;
}
...
burning_quarter_cart = obj {
	...
	act = function()
		return [[
			...
			Трупы под повозкой помимо цели....
		]];
	end;
}
...
burning_quarter_salers_counter = obj {
	nam = 'Лоток торговца';
	dsc = [[
		Посреди квартара когда-то велась торговля...
		{Палатка}, валяется волчья шкура в крови и перевёрнутый котелок...
	]];
	act = function()
		return [[
			...
