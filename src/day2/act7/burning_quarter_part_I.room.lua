...
burning_quarter = room {
	...
	enter = function()
		...
		return [[
			...
			^
			Оказавшись в узком коридоре между зданий, ты сбавляешь ход.
			...
			^
			В ответ тебе открывается открывается одна из дверей в ближайшем доме.
			На пороге её высится громила в ореоле приглушённого света.
			Из-за его спины доносятся едва различимые стоны.
			^
			Ты выставляешь перед собой меч, но удар сметает его куда-то в сторону.
			...
			В шею орка впивается недобитый ящер.
