...
burning_quarter_cart_chain = obj {
	...
	used = function(self, what)
		local text = [[
			...
			Сжав рукоять, ты замахиваешься и обрушиваешь оружие урук-хай на цепь.
			...
			как живая. Ты бъёшь ещё раз, опять по цепи, и её вырывает из крепления.
			^
		]];
			...
			if burning_quarter_corpses:disabled() then
				...
				if burning_quarter_salers_counter:disabled() then
					...
					if not burning_quarter_loaded_cart:disabled() then
						...
						return text .. [[
							Повозка приходит в движение, стремительно набирая скорость.
							Скатившись со склона, жутко громыхая бочками, она врезается в угол здания
							и исчезает во всполохе пламени. Разбрасывая снопы искр и изрыгая дым,
							дом складывается как карточный. Проход, скрывающий в себе богоизбранного
							и орочью банду, тонет в огне.
							^
							Любуясь учинённым тобой разрушением, ты начинаешь понимать,
							что чувствуют пироманьяки урук-хай -- разорители.
							^
							Через рёв бушующего пламени до тебя доносятся странные хлопки.
							Обернувшись, ты видишь аплодирующего тебе человека с сумасшедшей улыбкой на лице.
							^
							-- Неплохое зрелище, -- заключает проповедник, закончив хлопать,
							-- воодушевляет, не правда ли?
							^
							-- Ты? -- удивлённо произносишь ты, протирая глаза от золы.
							Но фигура в тёмных одеждах не пропадает.
							^
							-- Конечно я. А кого ты ожидал здесь увидеть? -- его улыбка исчезает,
							-- неужели своего почившего дружка из подполья или эту суку нелюдь?
						]];
					else
