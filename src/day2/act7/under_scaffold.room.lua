...
orc_slave = obj {
	...
	dsc = [[
		...
		Его тело смешивается с тьмой под эшафотом.
	]];
	act = function()
		walk 'slain_by_slave'
	end;
...
half_reptile = obj {
	...
	act = [[
		Ты внимательно смотришь на полуящера. Грубая тёмно-бурая кожа, шипы на спине,
		острые длинные когти, шакальи зубы. У безоружного человека против такой
		твари нет шансов.
		^
