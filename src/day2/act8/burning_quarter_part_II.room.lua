	...
	phr = {
		...
		};
		{
			...
			[[
				...
				никчёмность своего существования в битвах, и вот стал богоизбранным.
				Только послушай его теперь, одни рассуждения о долге, правосудии и законе.
				...
				Мыкаешься среди ругих оборванцев в какой-то глуши и пъёшь дни напролёт.
				И вот сейчас в твои руки попадает судьба целого города, а то и страны.
				...
				Бежишь от жизни прямо в лапы смерти к богоизбранному.
				Демарш жизни. Дезертир жизни.
				^
