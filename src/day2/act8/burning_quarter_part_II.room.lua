...
-- Смерть от трёх зомби
burning_quarter_hummer_death = function()
	return [[
	...
	used = function(self, what)
		...
		if what == burning_quarter_knife then
			...
			return [[
				...
				и делаешь быстрый выпад метя шею. Мертвец нелепо дёргается
				и нож врезается под ключицу. Ты с трудом высвобождаешь оружие,
				едва успев подставить тесак под удар кастета.
				Лезвие ножа намертво застревает между шипами.
				Ты лишь тратишь напрасно теряешь время чтобы вернуть своё оружие,
				и смердящий труп хватает тебя свободной рукой за шею.
