...
burning_quarter_priest = obj {
	...
	used = function(self, what)
		...
		if (what == burning_quarter_knife) then
			walk 'burning_quarter_part_II_gameover';
			return [[
				Ты резво набрасываешься на проповедника, ударяя ножом снизу вверх,
				надеясь вспороть ему грудную клетку.
				Но появившийся на пути твоего оружия кинжал, отводит удар в сторону.
				...
			]];
		end;
		if (what == burning_quarter_halberd) then
			...
			return [[
				^
				но тот отбивает его с неожиданной прытью.
