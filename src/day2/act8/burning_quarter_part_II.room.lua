	...
	phr = {
		{
			...
			[[
				-- Откуда ты столько знаешь? -- спрашиваешь ты с подозрением,
				...
				-- тем кто способен ходить в среди теней, известно многое.
			]];
			function()
			end;
		};
		{
			...
			[[
				...
				Тогда бы ты, рабозрался, ты всего лишь жалкий червь, ничтожество,
				которое ставит себя в центр вселенной.
				Ты недостоин исполнять Её волю! Видимо, даже боги ошибаются.
				Но я исправлю эту досадную ошибку.
			]];
			function()
			end;
		};
		{
			...
			[[
				...
				^
				-- Ещё один нелепый поводырь судьбы, -- усмехается безумец,
				-- всю жизнь пытавшийся...
				^
