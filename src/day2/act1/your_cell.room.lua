	...
	act = function()
		if _wants_cocaine then
			...
			return [[			
				...
				-- Заскучал?
				^
				-- Вроде того. Да и ты, я смотрю, не весёл. Может выручим друг-друга?
				^
				...
				принесла, что арестант у вас с грузом загремел. Мне бы совем чуть-чуть,
				горсточку. А я уж тебя развлеку как-нибудь. Обоим польза.
				^
				-- Ты колдун, чтоли, я не понял?
				...
				Вот теперь мучаюсь, расплачиваюсь. Выручишь, а?
				^
				...
				скопившегося вожделения. Выдержав паузу ты заходишьсяв притупе
				...
				^
				...за это время тебе удаётся незаметно пропихнуть
				10-килограммовый мешок через дырку в стене.
				^
				Обернувшись, ты видишь рядом с собой совершенно
