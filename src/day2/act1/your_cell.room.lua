	...
	inv = function()
		...
		if _rat_talk_about_tower then
			...
			return _rat_take .. [[
				...
				^
				-- Такое ощущуение, что пропавшие могли сущетвовать только внутри башни, такими
		...
		if _rat_talk_about_dust then
			...
			return _rat_take .. [[
				...
				^
				-- Можно и так сказать. Волшебники встречались среди людей и раньше. Но не все из
				них были готовы служить человечеству. 
				^
				-- Вот как.
				^
				-- Субстрат придумали эльфийские вельможы, не согласные с политикой
				Лесного Совета. Вместе с людьми
				они организовали отдельное государство. Чтобы защитить себя от гнева Леса,
				эти эльфы решили обучить людей магии массово.
				^
				-- Я не силён в истории, особенно в древней.
				^
				-- Это долгий разговор, и если я хочу превратиться обрано в человека, мне лучше
				приберечь силы. Мыслеречь это тоже магия.
				^
