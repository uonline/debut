	...
	entered = function()
		if _guard_just_died then
			...
			return [[
				...
				Ты втаскиваешь тело за дверь и оборачиваешься, чтобы
...
prison_chest = obj {
	nam = 'Сундук';
	dsc = [[
		На внушительного вида сундуке покоится привалившийся к стене {стражник}.
	...
	used = function(self, what)
		if what == rat then
			...
			return [[
				...
				чтобы покопаться в его карманах, но тебя останавливает писк из-за пазухи.
				...
				^
				Ещё до окончания твоей тирады глаза крысы на секунду вспыхивают
				лиловым светом, и замок с грохотом падает на пол. Стражник громко икает.
