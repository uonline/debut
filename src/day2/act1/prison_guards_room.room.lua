...
prison_guards_room = room {
	...
	entered = function()
		if _guard_just_died then
			...
			return [[
				Ты осторожно открываешь дверь и осматриваешь небольшую каморку.
...
prison_guard = obj {
	...
	used = function(self, what)
		if what == prison_board then
			...
			return [[
				Ты бъёшь стражника доской по голове и он падает с сундука на пол.
			]];
		end;
	end;
}
