	...
	used = function(self, what)
		if what == rat then
			...
			return [[
				...
				^
				-- Знаешь, а ты ведь не рассказал мне, о том кто ты? -- крыса, --
				не хотелось бы думать, что я помогаю какому-нибудь проходимцу или
				убийце.
				^
				...
				^
				-- Кажется в коридоре был выход на лестницу наверх, -- подсказывает маг.
			]]
		end
	end;
}
