...
prison_hall_fire_first = obj {
	...
	act = [[
		...
		крепления. Дверь одной из камер со скрипом открывается. Стражник
		прерывает свой кашель, чтобы икнуть.
		^
		Факел медленно опускается. Дверь камеры встаёт на место. Стражник
		начинает кашлять с новой силой.
	]];
}
