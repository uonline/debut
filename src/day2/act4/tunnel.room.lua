...
tunnel_leader = obj {
	...
	act = function()
		...
		about_exconsul = [[
			-- Он дал мне это, -- ты кладёшь на стол связку ключей, -- и сказал
			отыскать какого-то советника Конроя в башне и показать ему документы.
			^
			-- Ещё одна старая рухлядь, -- девушка недовольно кривит нос, -- в городе
			уже делают ставки, когда он исчезнет. Он единственный кто ещё торчит в
			этой башне.
			^
			-- Он думает, что там для него безопасней, -- усмехается бывший торгаш,
			крутя в руках связку ключей, -- действительно, для многих в этом городе
			он как кость в горле.
			^
		...
		-- Уходим в башню
		to_tower = [[
			-- Ты пойдёшь с нами в башню? -- обращается он к тебе.
			^
			...
			на дезертиров. Режим считает их потенциальной угрозой.
			^
			...
			улыбок, на разные случаи, -- правильно, неправильно это всего лишь слова. Никто
			не знает как жить эту жизнь правильно, но всё равно мы все живём её.
			Я лишь указываю тебе, что ты сможешь прожить дольше, если поможешь
			нам сейчас.
			^
			-- Ты забываешь, что это всего лишь дезертир, -- вмешивается девушка, --
			К чему все эти уговоры? Просто скажи, что перережешь ему глотку, если он
			откажется помогать.
			^
			Ты наблюдаешь ряд красивых белых зубов, обрамлённых улыбкой. Она обезоруживает.
			^
			...
			выправка ещё не пропала. Во-вторых, ты знаком с содержимом документов, и если что
			сможешь более менее внятно передать их суть. В-третьих пара человек маловато
			для такого предприятия, а четыре уже толпа. Ну и самое главное, я чувствую, что ты
			везучий чёрт. А везение это главное, что может понадобиться в этой проклятой башне,
			если хочешь найти там что-то или кого-то.
			^
			-- Ты забыл сказать, что не хочешь упускать из виду человека с такими сведениями, --
			сухо добавила девушка.
			^
			-- И это тоже, -- примирительно кивнул торгаш, -- Ну что, договорились?
			^
