...
tunnel_leader = obj {
	...
	act = function()
		...
		if _collector_drunk then
			...
			about_tower_mission = [[
				-- Итак, -- обращается он к тебе, -- мы тут с Полукровкой, -- его взгляд
				падает на девушку, -- задумали небольшое дельце.
			...
			about_tower_mission = [[
				...
				^
				-- Итак, мы с Полукровкой, -- он бросает взгляд в сторону девушки,
		...
		to_tower = [[
			...
			^
			Ты молчишь в ответ. Девушка Полукровка, скучая, рассматривает свои ногти.
			^
			...
			К тому же, ты в нём неплохо смотришься -- заправский режимник. Сразу видно, солдатская
