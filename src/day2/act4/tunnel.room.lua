...
tunnel_leader = obj {
	...
	act = function()
		...
		return [[
			...
			^
			Ветка диалога с Полукровкой, в которой нужно отметить её серьёзный тон.
			^
...
tunnel_halfblood = obj {
	...
	act = function()
		...
		if _guild_camp_halfblood_greeting then
			...
			return [[
				Ты пытаешься заговорить с девушкой, но тебя останавливает холодный
				взгляд. Тебе кажется, что её глаза со странным лиловым оттенком,
				светятся в темноте.
				^
