	...
	act = function()
		...
		if have('fatrat') and _guild_camp_fueled then
			...
			local scars = [[
				...
				крик Сайри.
				^
				-- Что это с твоей рукой? -- она показывает на запёкшиеся следы крови
...
guild_camp_halfblood = obj {
	...
	dsc = function()
		...
		if _tunnel_halfblood_greeting then
			return [[
				В полумраке между колонн ты замечаешь тоннель уводящий во тьму.
			]];
		end;
	...
	act = function()
		...
		if not _guild_camp_halfblood_greeting then
			...
			local greeting = [[
				...
				привязанное к одной из колон в вдалеке. Несколько ножей торчит из головы и паха
