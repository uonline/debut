	...
	phr = {
		...
		-- 2. Обращаешь внимание на возраст мага
		{
			...
			[[
				...
				ещё до основания Режима Ремана.
				^
				Ты не особенно в это веришь.
				^
				-- И как им это удаётся?
				^
				-- Магия поддерживает в них жизнь, защищает от болезней, -- ...
				-- Другая проблема -- память человека ограничена.
				Говорят они выносят свои воспоминания в специальные артефакты.
			]];
			function()
