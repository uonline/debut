	...
	phr = {
		...
		-- О культах
		{
			...
			[[
				...
				мире. Эта скорлупа за которой мы прячемся от реальности. Моя дала трещину
				тогда. И теперь я лишён покоя, кажется, до конца своих дней.
				Думаю, что умру так и не узнав истины. И это почему-то
				пугает меня. Словно что-то таится рядом со мной, оставаясь невидимым.
				^
				...
				чувствовал фальшивость видимого? Залитый солнцем городской пейзаж со
				снующими жителями. Протяни руку и эта искусная картина упадёт, обнажив
				нечто настоящее.
				^
				...
				достиг своих целей и я был тому свидетелем. События в Корадоре...
				^^
