	...
	phr = {
		...
		-- О культах
		{
			...
			[[
				...
				преданы ему. Слухи об исчезновении некоторых богоизбранных появляются с
				завидным постоянством. Джэйрана пропал ещё до начала войны. И многим
				это показалось подозрительным. Я кое-что узнал о нём. Силу богоизбранного
				Джэйраны выявили, когда он был уже в преклонных годах.
				...
				что его видели в разных мелких поселениях поселениях, в окрестностях
				...
				^
				^
				Вездесущие Инквизиторы и Извечная Война: Охота на богоизбранных-предателей;
				Богоизбранные могут присягнуть иному престолу.
			]];
		};
