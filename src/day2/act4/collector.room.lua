	...
	phr = {
		...
		-- Мрачная история Приграничья
		{
			...
			[[
				...
				^
				Тебе начало казаться, что он чудесным образом преобразился, словно, помолодел.
				Отшельник расправил плечи и разогнул спину, и теперь ты готов был согласиться,
				что видишь перед собой городского советника.
				^
				...
				расследование и справедливый суд. Я был одним из тех, кто должен был разобраться,
				...
				были совершены именно таким культом.
					^
				...
				^
				Расследованию так и не удалось завершиться. Жадность победила благоразумие.
				Два мелких лорда собрали войска и взяли город в осаду. Они подогревали
				народное недовольство, и в конце-концов ворвались в город. Начался хаос.
				Всех кого подозревали в связи с сектой отправляли на костёр. А через несколько
				...
				поступать вести о нападениях на деревни орочьих банд.
