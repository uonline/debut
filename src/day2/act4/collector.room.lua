	...
	phr = {
		-- О катакомбах
		{
			...
			[[
				...
				Карты Линары были составлены ими по описаниям эльфов.
					^2. Тантикул и руины Союза на скалистом полуострове:
						^ -- Эльфы предупреждали наших предков, чтобы они осваивали
						Скалистый полуостров полностью. По их словам Тантикул уже был основан
						в рискованном месте. Наши предки послушались их. Этот негласный закон
