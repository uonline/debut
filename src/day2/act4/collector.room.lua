...
collector_man = obj {
	...
	act = function()
		...
		return [[
			...
			^
			-- Он я его сменил. У меня к тебе дело, старик.
			^
	...
	phr = {
		...
		-- О культах
		{
			...
			[[
				...
				пугает меня. Словно что-то таится рядом со мной, так оставаясь невидимым.
				^
				...
				воображение удерживает тебя. Тебе почему-то кажется безопасным
				...
				и став богоизбранных он решил их приумножить. Он отправился в Приграничье
				...
				существует множество запретных способов достижения невероятной силы. Мне они не
				ведомы, но все эти культы и секты прямое тому доказательство.
				^
