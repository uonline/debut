...
lane_dead_citizen = obj {
	...
	act = [[
		...
		Ты механически подходишь ближе, чтобы рассмотреть лежащего.
		^
		...
		Хотя в тоже время, ты хорошо понимаешь, что то, что у тебя было,
		...
		^
		Скелет твоей жизни, жизни армейского пса и беглеца-дерезртира,
		догорает вместе с этим городом.
	]];
}
