...
elder_dlg = dlg {
	...
	hideinv = true;
	entered = [[
		-- Прекрасное утро, мой мальчик! -- с улыбкой говорит старейшина. В первую вашу встречу ты принял его за спятившего старика и сильно удивился, когда узнал с каким почтением к нему относится вся деревня.
	]];
	phr = {
		{
			tag = 'why_so_dead';
			...
			[[
				...
				^
				-- Чтож, печально это слышать. Но тебе не стоит
				...
				^
				Страик протягивает тебе какой-то предмет. Взглянув на него, 
