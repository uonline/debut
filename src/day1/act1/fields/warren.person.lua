	...
	phr = {
		{
			tag = 'elder_hates_you';
			false;
			'Эй, Уорри. Я тут был у нашего старика...';
			'Уорри молча указывает на заросшую лужайку у крыльца. В густой тени дома тебе удаётся разглядеть молот. Пожимая плечами, ты подбираешь его.';
			function()
