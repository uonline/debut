...
wh_book = obj {
	...
	act = [[
		^
		Но твоё внимание привлекает записка, между первыми листами.
		Ты несколько раз перечитываешь её странное содержание.
		^
		^
		"Я знаю ты много раз задавался вопросами лишнными смысла.
		Одним из них был:
		что такое Вождь для человека?
		^
		Я с радостью предложу тебе один из ответов,
		а заодно и мой совет.
		^
		Вождь -- это звезда в бесконечной черноте космоса,
		это огонь в адской бездне.
		Свет его ослепляет и человек готов совершать
		любые подвиги, любые бесчинства, любые зверства.
		Если хочешь остаться человеком, гаси звёзды, туши огонь
		в своём сознании.
		^
		Оставайся во тьме.
		^
		Я предоставляю тебе все средства.
		^
		Б.Д."
		^
		^
		Особенно тебя завораживает подпись "Б.Д.",
		настолько витиевато она исполнена.
	]];
}
