...
private_lands = room {
	...
	dsc = [[
		Ты стоишь около хижины лесника. Лордская династия всегда отличалсь богатством,
		и хижина ее слуги -- прекрасное тому напоминанием: она украшена роскошной
		скульптурой оленя, небольшими колоннами и покрыта свежей краской. Правда
		олень давно порос мхом и лишился нескольких рогов, некоторые колонны уже
