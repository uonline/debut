photo_scroll = obj {
	...
	inv = [[
		...
		Пергамент испещерён странными символами, составленными в необычный рисунок
		...
		и остаётся для тебя загадкой. Почувствовав, что некоторые символы уже
		начинают шевелиться, ты поспешно скручиваешь свиток.
	]];
}
