	...
	phr = {
		{
			...
			[[
				...
				я понял твои желания. Один момент, -- он поспешно собирает что-то из внушительного вида
				сундука во внушительный свёрток...
				-- Вот, возьми, это все мои эскизы по этой работе. Мы с моей натурщицей,
				довольно долго выбирали подходящую позу для финального варианта. К тому же,
				там есть первый вариант картины, неудачный. Думаю тебя это устроит?
				^
